...
| [embedded-support.md](embedded-support.md) | Which crates are supported Rust libraries (D5): the embedded datastore's declared surface, feature sets, minimum compiler and how its isolated consumer qualifies them; every other crate is internal |
...
| [../../docs/lab/README.md](../../docs/lab/README.md) | **Build your own AI memory governance lab**: the runnable companion to creating-a-lab.md. A disposable Server, a corpus slice, shape and runbook, an answer key held by a grader script, and the ledger's handling of a planted contradiction, with a worked example |
