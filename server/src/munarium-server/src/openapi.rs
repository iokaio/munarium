...
#[openapi(
    ...
    paths(
        ...
        crate::providers_api::provider_diagnostics,
        crate::providers_api::provider_complete,
        crate::providers_api::provider_embed,
        crate::providers_api::healthai,
        crate::command_recovery::policy,
        crate::command_recovery::enable,
        crate::command_recovery::receipt,
        crate::source_retention_api::change_source_retention,
        crate::source_retention_api::list_source_retention,
        ...
        crate::money_api::monetary_report,
        crate::budget_api::budget_evidence,
        crate::budget_api::reconcile_budget,
        crate::budget_api::budget_adjustments,
        crate::budget_api::budget_usage_report,
        crate::money_api::monetary_prices,
        crate::money_api::add_monetary_price,
        crate::money_api::add_monetary_observation,
    ...
    components(schemas(
        ...
        munarium_api_types::monetary::MonetaryRate,
        munarium_api_types::monetary::MonetaryBasis,
        munarium_api_types::monetary::MonetaryPrice,
        munarium_api_types::monetary::MonetaryUsage,
        munarium_api_types::monetary::MonetaryObservation,
        munarium_api_types::monetary::MonetaryCalculation,
        munarium_api_types::monetary::MonetaryCoverage,
        munarium_api_types::monetary::MonetaryAttempt,
        munarium_api_types::monetary::MonetaryReport,
        munarium_api_types::monetary::MonetaryPriceReceipt,
        ...
        munarium_api_types::ProviderDiagnosticsResponse,
        munarium_api_types::CommandRecoveryPolicy,
        munarium_api_types::CommandRecoveryReceipt,
        munarium_api_types::SourceRetentionRequest,
        munarium_api_types::SourceRetentionRecord,
        munarium_api_types::SourceRetentionList,
